...
\include{kapitel/20_Planung}
\include{kapitel/30_Grundlagen}
\include{kapitel/40_Entwicklung}
\include{kapitel/45_Messung}
\include{kapitel/50_Zusammenfassung}
\include{kapitel/60_Ausblick}
\include{kapitel/70_Anhang}
...
\listoffigures
%\lstlistoflistings
\include{kapitel/80_Literaturverzeichnis}
